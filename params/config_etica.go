...
var (
	...
	EticaChainConfig = &coregeth.CoreGethChainConfig{
		...
		EticaSmartContractv3: big.NewInt(5_888_000), // Etica smart contract (Guardian, Etica Hardfork 2) Warning: dont forget set to RandomX hardfork height
		EticaRandomX:         big.NewInt(5_888_030), // Etica smart contract (Guardian, Etica Hardfork 2) [EticaRandomX needs EticaSmartContractv3] Warning: dont forget set to RandomX hardfork height
