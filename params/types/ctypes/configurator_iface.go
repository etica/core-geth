...
type ProtocolSpecifier interface {
	...
	GetEticaSmartContractv3Transition() *uint64
	SetEticaSmartContractv3Transition(n *uint64) error

	// RandomX:
	GetEticaRandomXTransition() *uint64
	SetEticaRandomXTransition(n *uint64) error

	// Safeguarded addresses EticaSubset1:
	GetEticaSubset1Transition() *uint64
	SetEticaSubset1Transition(n *uint64) error

	GetEticaSmartContractv5Transition() *uint64
	SetEticaSmartContractv5Transition(n *uint64) error

	GetEticaSmartContractv6Transition() *uint64
	SetEticaSmartContractv6Transition(n *uint64) error
