...
var (
	...
	CrucibleChainConfig = &coregeth.CoreGethChainConfig{
		...
		EticaSmartContractv3: big.NewInt(1_861_550), // Etica smart contract (Guardian, Etica Hardfork 2) Warning: dont forget set to RandomX hardfork height // to be put back: 1_862_600
		EticaRandomX:         big.NewInt(1_861_570), // Etica smart contract (Guardian, Etica Hardfork 2) [EticaRandomX needs EticaSmartContractv3] Warning: dont forget set to RandomX hardfork height // tobe put back: 1_862_620
